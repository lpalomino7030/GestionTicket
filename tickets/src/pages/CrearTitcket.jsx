...
useEffect(() => {
  const loadData = async () => {
    try {
      ...
      setusuarioAsignar(Tecnicos.data);

      const Estados = await axiosClient.get(`/tickets/estadosTicket`);
            ...
            <form className="FormCreateTk" onSubmit={handleSubmit}>
                ...
                <div className="addFileCard">
                    {(id) ? (<div className="form-group">
                        ...
                        <select
                            value={crearTicket.id_estado}

                            id="Estados"
                            name="Estados"
                            onChange={(e) =>
                                setTicket({ ...crearTicket, id_estado: e.target.value })
                            }
                            required
                        >
                            <option value="">Selecciona Estado</option>
                            {
                                estadosAsignar.map((estados) => (
                    ...
                    </div>) : (<div className="form-group addfile">
